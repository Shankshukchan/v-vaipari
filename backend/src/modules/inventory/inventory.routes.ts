 ...
 * GET    /api/inventory/barcode/:barcode — find product by barcode
...
import {
  listHandler, lowStockHandler, getHandler, getBarcodeHandler,
...
router.get('/barcode/:barcode', getBarcodeHandler);
